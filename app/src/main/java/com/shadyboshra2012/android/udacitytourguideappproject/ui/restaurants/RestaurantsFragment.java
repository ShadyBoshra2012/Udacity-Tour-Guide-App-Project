package com.shadyboshra2012.android.udacitytourguideappproject.ui.restaurants;
...
public class RestaurantsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        String[] locationsName = new String[]{getString(R.string.resturant_location_name1),
                getString(R.string.resturant_location_name2), getString(R.string.resturant_location_name3),
                getString(R.string.resturant_location_name4)};
