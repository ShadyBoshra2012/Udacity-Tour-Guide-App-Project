...
public class TheatersFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        TheatersViewModel theatersViewModel =
                ViewModelProviders.of(this).get(TheatersViewModel.class);
        ...
        String[] locationsName = new String[]{getString(R.string.theater_location_name1),
                getString(R.string.theater_location_name2), getString(R.string.theater_location_name3)};
